...
function MenuTrigger({ tag, className, ...attributes }) {
  return React.createElement(tag, {
    className: `menu-trigger ${className} border-0 h-100 color-pagination fw-normal fsp-14 rounded-0 focus-none`,
    ...attributes,
  });
}
...
class Menu extends React.Component {
  ...
  render() {
    ...
    const rootClassName = this.state.expanded ? 'menu expanded h-100' : 'menu h-100';
